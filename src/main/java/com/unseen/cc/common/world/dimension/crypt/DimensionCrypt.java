package com.unseen.cc.common.world.dimension.crypt;

import com.unseen.cc.common.world.dimension.base.ModChunkGenerator;
...
/**
 * Dimension that extends World Provider
 */
public class DimensionCrypt extends WorldProvider {
    // Overridden to change the biome provider
    @Override
    protected void init() {
        //this.biomeProvider = customBiomeProvider;
        //this.hasSkyLight = false;
        this.world.setAllowedSpawnTypes(true, true);
    }

    @Override
    public DimensionType getDimensionType() {
        return ModDimensions.CRYPT_DIMENSION;
    }

    @Override
    public IChunkGenerator createChunkGenerator() {
        return new ModChunkGenerator(world, world.getSeed(), true, "") {
            @Override
