package com.unseen.cc.common.world.dimension.base;
...
public abstract class ModChunkGenerator implements IChunkGenerator {
    // The stone block
    ...
    public ModChunkGenerator(World worldIn, long seed, boolean mapFeaturesEnabledIn, String generatorOptions, Block stone, Block ocean, MapGenStructure[] structures) {
    ...
    public ModChunkGenerator(World worldIn, long seed, boolean mapFeaturesEnabledIn, String generatorOptions) {
        this.world = worldIn;
