package com.unseen.cc.common.world.structures.base;
...
/**
 * This is misc Ground Height Utility for structures
 */
public class GenUtils {


    public static int getGroundHeight(ModStructureTemplate template, ModChunkGenerator gen, Rotation rotation) {
     ...
     */
    public static int getGroundHeight(BlockPos pos, ModChunkGenerator gen, Rotation rotation) {
