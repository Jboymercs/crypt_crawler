package com.unseen.cc.common.entity.base.navigation;
...
public class MobGroundNavigate extends PathNavigate {
    public MobGroundNavigate(EntityLiving entityIn, World worldIn) {
    ...
    protected PathFinder getPathFinder() {
        this.nodeProcessor = new MobNodeProcessor();
